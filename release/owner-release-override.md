...
this initial publication. This authorization covers local PyPI token
publication in dependency order after the final compatible 0.1-series sibling
artifacts have passed their package checks.
...
remain mandatory operational checks and are not waived.
