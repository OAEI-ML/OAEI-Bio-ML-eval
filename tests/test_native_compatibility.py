    ...
    def test_final_stack_and_historical_attestations_are_bound(self) -> None:
            ...
            self.contract["sibling_consumers"],
            {
                "pyowl2vec-star-projector": {
                    ...
                    "production_release_commit": (
                        "e96ce0018d02f20ae2473d3ef2f9f40f948e5d59"
                    ),
                    "production_release_tree": (
                        "7c9237e1f1858b63c504187e8e5be3539ddfdd91"
                    ),
        ...
        self.assertEqual(
            reasoners["pyelk"],
            {
                ...
                "production_release_commit": ("b7b373165f6cbc3452f022c542731d7b5f2f73be"),
                "production_release_tree": ("b31a882c8d96a9907ceeaa8c6a40bb77890c94af"),
                "production_release_version": "0.2.0",
                "prior_production_release": {
        ...
        self.assertEqual(
            reasoners["pyhermit"],
            {
                ...
                "production_release_commit": ("c4bdbbc7581281cd46803a5c0eafd1f8a1f3c2af"),
                "production_release_tree": ("c9ef2915b8df669e64a6f0d6c4900d6e859bfaf0"),
                "production_release_version": "0.2.0",
                "prior_production_release": {
